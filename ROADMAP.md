...
| Kod     | Durum   | Başlık                                                                                                                  |
| ------- | ------- | ----------------------------------------------------------------------------------------------------------------------- |
| `P1-16` | ⬜ Açık | Register flow user ve tenant oluşturmayı fazla birbirine bağlı yapıyor.                                                 |
| `P1-17` | ⬜ Açık | RegisterCommandValidator email uniqueness kontrolü yapmıyor.                                                            |
| `P1-18` | ⬜ Açık | Login, forgot password, reset password, email confirmation endpointleri rate-limit açısından tekrar gözden geçirilmeli. |
| `P1-19` | ⬜ Açık | MFA açık kullanıcıda refresh token davranışı testlerle korunmalı.                                                       |
| `P1-20` | ⬜ Açık | Account Preferences optimistic concurrency UX eksik kalabilir.                                                          |
| `P1-21` | ⬜ Açık | Account security notification publisher no-op/stub gibi duruyor.                                                        |
| `P1-22` | ⬜ Açık | Account integration event publisher gerçek publish etmiyor olabilir.                                                    |
| `P1-23` | ⬜ Açık | Avatar/media upload tarafında orphan cleanup eklenmeli.                                                                 |
| `P1-24` | ⬜ Açık | Avatar/media upload için magic-byte validation ve güvenlik taraması eklenmeli.                                          |
| `P1-25` | ⬜ Açık | Account session ekranı gerçek zamanlı güncellenmeli.                                                                    |
...
| Kod     | Durum   | Başlık                                                                 |
| ------- | ------- | ---------------------------------------------------------------------- |
| `P1-26` | ⬜ Açık | CRM session/profile endpointleri tam bağlanmalı.                       |
| `P1-27` | ⬜ Açık | CRM backend policy’leri frontend capability map’e çevrilmeli.          |
| `P1-28` | ⬜ Açık | CRM dashboard verilerinde hardcoded fallback metinler var.             |
| `P1-29` | ⬜ Açık | Lead/Customer duplicate detection UI tamamlanmalı.                     |
| `P1-30` | ⬜ Açık | CRM import/export akışları production-grade yapılmalı.                 |
| `P1-31` | ⬜ Açık | CRM mutation işlemlerine audit log standardı getirilmeli.              |
| `P1-32` | ⬜ Açık | CRM public capture endpointleri abuse koruması istiyor.                |
| `P1-33` | ⬜ Açık | Marketing unsubscribe/consent endpointleri signed token ile çalışmalı. |
| `P1-34` | ⬜ Açık | Integration webhook endpointlerinde replay protection güçlendirilmeli. |
| `P1-35` | ⬜ Açık | Mock integration provider production’da kapalı olmalı.                 |
| `P1-36` | ⬜ Açık | CRM modül registry ile backend endpoint durumu eşleştirilmeli.         |
| `P1-37` | ⬜ Açık | Date/time formatları user preference üzerinden global uygulanmalı.     |
| `P1-38` | ⬜ Açık | CRM error handling standardize edilmeli.                               |
...
| `P2-80` | ⬜ Açık | Backup/restore runbook eksikse yazılmalı.                           |
...
| Kod     | Durum   | Başlık                                                                    |
| ------- | ------- | ------------------------------------------------------------------------- |
| `P2-81` | ⬜ Açık | admin-web ve mobile-app şu an sadece placeholder gibi duruyor.            |
| `P2-82` | ⬜ Açık | native klasörü gerçek uygulama mı doküman mı netleşmeli.                  |
| `P2-83` | ⬜ Açık | Eski path kalıntıları temizlenmeli.                                       |
| `P2-84` | ⬜ Açık | Environment matrix dokümanı hazırlanmalı.                                 |
| `P2-85` | ⬜ Açık | Release checklist otomatik doğrulanabilir hale getirilmeli.               |
| `P2-86` | ⬜ Açık | Domain/cookie stratejisi net dokümante edilmeli.                          |
