...
export const crmModuleRegistry: CrmModuleRegistryItem[] = [
  ...
  },
  {
    id: "ticket-sla",
    title: "Ticket SLA",
    description: "Ticket SLA policy and escalation rule management with workspace read views.",
    path: "/ticket-sla",
    group: "Service / Support",
    iconKey: "alarm-clock",
    status: "active",
  ...
  },
  {
    ...
    description: "Ticket workflow queues, assignments, and status transition actions.",
