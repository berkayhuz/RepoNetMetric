...
export const crmModuleRegistry: CrmModuleRegistryItem[] = [
  ...
  },
  {
    ...
    description: "Work management workspace tasks are available as read-only via workspace API.",
    ...
    endpointDiscoveryStatus: "source_visible",
    implementationPhase: "Implemented (read-only workspace)",
  },
  {
  ...
  },
  {
    id: "tasks",
    title: "Tasks",
    description: "Read-only task list from WorkManagement workspace endpoint.",
    path: "/tasks",
    group: "Operations",
    ...
    backendModuleFolder: "WorkManagement",
    endpointDiscoveryStatus: "source_visible",
    implementationPhase: "Implemented (read-only list)",
  },
  {
    id: "activities",
    title: "Activities",
