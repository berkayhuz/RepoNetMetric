...
export const crmModuleRegistry: CrmModuleRegistryItem[] = [
  ...
  },
  {
    id: "deal-management",
    title: "Deals",
    description: "Deal records with list, detail, and basic mutation flows.",
    path: "/deals",
    group: "Sales",
    iconKey: "handshake",
    status: "active",
  ...
  },
  {
    ...
    description: "Work management workspace supports read and task/meeting creation flows.",
    ...
    endpointDiscoveryStatus: "source_visible",
    implementationPhase: "Implemented (workspace + create flows)",
  },
  {
  ...
  },
  {
    id: "tasks",
    title: "Tasks",
    description: "Task list plus create task and meeting schedule flows via WorkManagement.",
    path: "/tasks",
    group: "Operations",
    ...
    backendModuleFolder: "WorkManagement",
    endpointDiscoveryStatus: "source_visible",
    implementationPhase: "Implemented (list + create flows)",
  },
  {
    id: "activities",
    title: "Activities",
