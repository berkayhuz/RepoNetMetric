...
| Opportunity Management          | OpportunityManagement    | Yes                               | Yes          | Yes            | Yes              | contract_pending | Opportunity + pipeline phase              |
| Pipeline Management             | PipelineManagement       | Yes                               | Yes          | Yes            | Yes              | contract_pending | Pipeline board read-only phase            |
...
- crm-web implements lead list/detail/create/update/delete and keeps remaining non-implemented modules as route shells.
