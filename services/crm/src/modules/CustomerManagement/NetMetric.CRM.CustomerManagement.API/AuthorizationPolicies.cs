...
public static class AuthorizationPolicies
{
    ...
    private static IEnumerable<string> GetPolicyNames()
    {
        ...
        yield return LostReasonsManage;
        yield return LostReasonsRead;
        yield return OpportunityPipelineManage;
        yield return OpportunityStageHistoryRead;
        yield return LeadConversionsManage;
        yield return LeadConversionsRead;
    }
}
