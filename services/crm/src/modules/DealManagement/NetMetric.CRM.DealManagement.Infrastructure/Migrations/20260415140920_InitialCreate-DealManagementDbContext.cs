...
{
    /// <inheritdoc />
    public partial class InitialCreateDealManagementDbContext : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DealOutcomeHistories", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompetitorName = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    CompetitorPrice = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    CustomerFeedback = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WinLossReviews", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Opportunity_LostReasons_LostReasonId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Deals_Opportunity_OpportunityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DealOutcomeHistories_TenantId_DealId_OccurredAt",
                table: "DealOutcomeHistories",
                columns: new[] { "TenantId", "DealId", "OccurredAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WinLossReviews_TenantId_DealId",
                table: "WinLossReviews",
