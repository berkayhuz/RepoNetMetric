...
public sealed class LandingCaptureConfiguration : IEntityTypeConfiguration<LandingCapture>
{
    public void Configure(EntityTypeBuilder<LandingCapture> builder)
    {
        builder.ToTable("LandingCapture");
