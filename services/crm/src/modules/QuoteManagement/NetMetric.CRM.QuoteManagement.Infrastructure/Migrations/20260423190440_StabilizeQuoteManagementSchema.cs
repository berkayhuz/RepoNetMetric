...
{
    /// <inheritdoc />
    public partial class StabilizeQuoteManagementSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinimumBudget = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    MaximumBudget = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    RequiredCapabilities = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                    RecommendedBundleCodes = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GuidedSellingPlaybooks", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaximumDiscountRate = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GuidedSellingPlaybooks_TenantId_Name",
                schema: "quote",
                table: "GuidedSellingPlaybooks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductRules_TenantId_Name",
                schema: "quote",
                table: "ProductRules",
                columns: new[] { "TenantId", "Name" },
                unique: true,
