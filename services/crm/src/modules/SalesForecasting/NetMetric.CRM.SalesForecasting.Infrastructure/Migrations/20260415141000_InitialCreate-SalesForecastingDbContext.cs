...
{
    /// <inheritdoc />
    public partial class InitialCreateSalesForecastingDbContext : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ForecastAdjustments", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PeriodEnd = table.Column<DateOnly>(type: "date", nullable: false),
                    OwnerUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ForecastCategory = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    PipelineAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    WeightedPipelineAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    ...
                    ClosedWonAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    QuotaAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ForecastAdjustments_TenantId_PeriodStart_PeriodEnd_OwnerUserId",
                table: "ForecastAdjustments",
                columns: new[] { "TenantId", "PeriodStart", "PeriodEnd", "OwnerUserId" });

            migrationBuilder.CreateIndex(
                name: "IX_ForecastSnapshots_TenantId_PeriodStart_PeriodEnd_OwnerUserId_Name",
                table: "ForecastSnapshots",
                columns: new[] { "TenantId", "PeriodStart", "PeriodEnd", "OwnerUserId", "Name" },
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesQuotas_TenantId_PeriodStart_PeriodEnd_OwnerUserId",
                table: "SalesQuotas",
                columns: new[] { "TenantId", "PeriodStart", "PeriodEnd", "OwnerUserId" },
                unique: true,
                filter: "[OwnerUserId] IS NOT NULL");
