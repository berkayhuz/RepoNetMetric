...
public sealed class UpdateSupportInboxConnectionCommandValidator : AbstractValidator<UpdateSupportInboxConnectionCommand>
{
    public UpdateSupportInboxConnectionCommandValidator(Func<string, IPAddress[]>? resolveHost = null)
    {
