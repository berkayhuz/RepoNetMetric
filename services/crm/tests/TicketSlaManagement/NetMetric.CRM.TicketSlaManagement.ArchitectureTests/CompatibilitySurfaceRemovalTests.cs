...
namespace NetMetric.CRM.TicketSlaManagement.ArchitectureTests;

public sealed class CompatibilitySurfaceRemovalTests
{
    [Fact]
    public void TicketSla_Compatibility_Controllers_Should_Not_Be_Public_Surface()
    {
        FindTicketControllers(type => type.Name.Contains("Sla", StringComparison.OrdinalIgnoreCase)).Should().NotBeEmpty();
    }
